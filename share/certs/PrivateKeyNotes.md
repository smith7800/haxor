...
unlocked to sign the haxor-Qt.app bundle.
...
allowing somebody to distribute a haxor-Qt.app or haxor-qt-setup.exe with a valid
...
that the haxor-qt.exe file inside the installer had not been tampered with.
